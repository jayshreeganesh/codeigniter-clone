<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Viewing #<?= $product->id ?></p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-6 md:p-8">
            ...
            <div class="mt-8 pt-4 border-t border-slate-100 flex justify-between items-center">
                <a href="<?= site_url('products/delete/' . $product->id) ?>" onclick="return confirm('Are you sure you want to delete this product?');" class="text-sm text-rose-600 hover:text-rose-800 font-medium">
                    <i class="fa-regular fa-trash-can mr-1"></i> Delete Product
                </a>
                <div class="space-x-2">
                    <a href="<?= site_url('products') ?>" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-lg transition">
                        Back
                    </a>
                    <a href="<?= site_url('products/edit/' . $product->id) ?>" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg shadow-sm transition">
